...
describe('SettingsHomeComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({ imports: [SettingsHomeComponent] }).compileComponents();
  ...
  it('should display Paramètres title', () => {
    expect((fixture.nativeElement as HTMLElement).querySelector('h1')?.textContent).toContain('Paramètres');
  });
});
